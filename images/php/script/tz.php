...
<table>
  ...
  <tr>
    ...
    <td width="18%">
		...
		$disFuns=get_cfg_var("disable_functions");
		?>
		<?php echo "<a href='$phpSelf?act=phpinfo' target='_blank'>PHPINFO</a>";?>
    </td>
...
<table>
  ...
  <tr>
    <td>MCrypt: </td>
    <td><?php echo isfun("mcrypt_list_modes");?></td>
    <td>Mhash Count: </td>
...
<table>
  ...
  <tr>
    ...
    if(function_exists("mysqli_get_server_info")) {
        ...
        $s = $s ? '&nbsp; mysqli_server version: '.$s : '';
	    $c = '&nbsp; mysqli_client version: '.@mysqli_get_client_info();
        echo $s;
    }
    ?>
	</td>
