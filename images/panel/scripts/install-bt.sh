...
apt update 
apt install -y --no-recoomends-install curl wget
...
# while [ "$go" != 'y' ] && [ "$go" != 'n' ]
# do
# 	read -p "Do you want to   directory now?(y/n): " go;
# done
...
echo "Bt-Panel Will be install to: $setup_path"
